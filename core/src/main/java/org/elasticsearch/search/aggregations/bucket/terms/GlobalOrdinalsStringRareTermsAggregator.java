 ...
 */
public class GlobalOrdinalsStringRareTermsAggregator extends AbstractStringTermsAggregator {
    ...
    public GlobalOrdinalsStringRareTermsAggregator(String name, AggregatorFactories factories, ValuesSource.Bytes.WithOrdinals valuesSource,
    ...
    /**
     * Variant of {@link GlobalOrdinalsStringRareTermsAggregator} that rebases hashes in order to make them dense. Might be
     * useful in case few hashes are visited.
     */
    public static class WithHash extends GlobalOrdinalsStringRareTermsAggregator {
    ...
    /**
     * Variant of {@link GlobalOrdinalsStringRareTermsAggregator} that resolves global ordinals post segment collection
     ...
     */
    public static class LowCardinality extends GlobalOrdinalsStringRareTermsAggregator {
