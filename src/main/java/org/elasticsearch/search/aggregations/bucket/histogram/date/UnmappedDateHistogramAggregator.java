 ...
 *
 */
public class UnmappedDateHistogramAggregator extends BucketAggregator {
    ...
    public static class Factory extends BucketAggregator.Factory<UnmappedDateHistogramAggregator, Factory> {
