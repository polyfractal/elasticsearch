...
import org.elasticsearch.search.aggregations.bucket.multi.histogram.ScriptHistogramCollector;
 ...
 *
 */
public class ScriptDateHistogramAggregator extends SingleBucketAggregator implements ScriptHistogramCollector.Listener {
    ...
    public static class Factory extends SingleBucketAggregator.Factory<ScriptDateHistogramAggregator, Factory> {
