...
public class NestedAggregator extends SingleBucketAggregator implements ReaderContextAware {
    ...
    public static class Factory extends Aggregator.CompoundFactory {
        ...
        @Override
        public NestedAggregator create(AggregationContext aggregationContext, Aggregator parent) {
            return new NestedAggregator(name, factories, path, aggregationContext, parent);
        }
    }
}
