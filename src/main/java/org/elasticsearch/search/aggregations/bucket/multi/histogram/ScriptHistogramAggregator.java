 ...
 */
public class ScriptHistogramAggregator extends SingleBucketAggregator implements ScriptHistogramCollector.Listener {
    ...
    public static class Factory extends SingleBucketAggregator.Factory<ScriptHistogramAggregator, Factory> {
