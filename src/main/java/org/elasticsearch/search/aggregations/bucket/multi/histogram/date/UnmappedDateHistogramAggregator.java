 ...
 *
 */
public class UnmappedDateHistogramAggregator extends SingleBucketAggregator {
    ...
    public static class Factory extends SingleBucketAggregator.Factory<UnmappedDateHistogramAggregator, Factory> {
