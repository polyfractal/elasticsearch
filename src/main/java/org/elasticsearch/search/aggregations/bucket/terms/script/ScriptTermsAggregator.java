...
package org.elasticsearch.search.aggregations.bucket.terms.script;
 ...
 *
 */
public class ScriptTermsAggregator extends BucketAggregator {
    ...
    public static class Factory extends BucketAggregator.Factory<ScriptTermsAggregator, Factory> {
