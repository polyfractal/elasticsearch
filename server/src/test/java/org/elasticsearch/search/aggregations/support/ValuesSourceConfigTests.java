...
public class ValuesSourceConfigTests extends ESSingleNodeTestCase implements ResolvableUnmappedMissingAggFactory {

    @Override
    public ValuesSource resolveUnmappedMissingVS(Object missingValue) {
        throw new UnsupportedOperationException("lol shouldn't be here");
    }
    ...
    public void testKeyword() throws Exception {
        ...
        try (Searcher searcher = indexService.getShard(0).acquireSearcher("test")) {
            ...
            ValuesSource.Bytes valuesSource = config.toValuesSource(context, this);
    ...
    public void testEmptyKeyword() throws Exception {
        ...
        try (Searcher searcher = indexService.getShard(0).acquireSearcher("test")) {
            ...
            valuesSource = config.toValuesSource(context, this);
    ...
    public void testLong() throws Exception {
        ...
        try (Searcher searcher = indexService.getShard(0).acquireSearcher("test")) {
            ...
            ValuesSource.Numeric valuesSource = config.toValuesSource(context, this);
            LeafReaderContext ctx = searcher.reader().leaves().get(0);
