...
public class ScriptHistogramCollector extends Aggregator.Collector {
    ...
    private final SingleBucketAggregator aggregator;
    ...
    public ScriptHistogramCollector(SingleBucketAggregator aggregator, SearchScript script, Rounding rounding, Listener listener) {
    ...
    public static class BucketCollector extends SingleBucketAggregator.BucketCollector {

        public final long key;
        public long docCount;
        public List<Aggregator> aggregators;

        BucketCollector(SingleBucketAggregator parent, Scorer scorer, AtomicReaderContext context, long key) {
