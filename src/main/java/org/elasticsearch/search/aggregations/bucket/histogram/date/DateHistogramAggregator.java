...
import org.elasticsearch.search.aggregations.bucket.histogram.HistogramCollector;
...
public class DateHistogramAggregator extends FieldDataBucketAggregator implements HistogramCollector.Listener {
    ...
    public static class Factory extends BucketAggregator.Factory<DateHistogramAggregator, Factory> {
